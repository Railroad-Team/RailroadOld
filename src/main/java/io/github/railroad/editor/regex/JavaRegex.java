...
public final class JavaRegex {
	...
	public static final Pattern PATTERN = Pattern.compile("(?<KEYWORD>" + KEYWORD_PATTERN + ")" + "|(?<VAR>" + VAR_PATTERN
			+ ")" + "|(?<LITERAL>" + LITERAL_PATTERN + ")" + "|(?<CONSTVAR>" + CONST_VARIABLE_PATTERN + ")" + "|(?<VARIABLE>"
			+ VARIABLE_PATTERN + ")" + "|(?<PAREN>" + PAREN_PATTERN + ")" + "|(?<BRACE>" + BRACE_PATTERN + ")"
